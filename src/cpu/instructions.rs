...
pub enum Instruction {
    ...
    JumpConditional {
        condition: super::registers::ConditionCode,
        target: Operand,
    },
    Call {
        target: Operand,
...
fn estimate_cycles(instruction: &Instruction) -> u32 {
    match instruction {
        ...
        Instruction::Nop | Instruction::Mov { .. } => 1,
        ...
        Instruction::Load { .. } | Instruction::Store { .. } => 3,

        // Branchements - 2 cycles si pas pris, 4 si pris
        Instruction::Jump { .. } | Instruction::JumpConditional { .. } => 4,

        // Appels et retours - 5 cycles
        Instruction::Call { .. } | Instruction::Return => 5,

        // Instructions de comparaison - 2 cycles
        Instruction::Compare { .. } | Instruction::Test { .. } => 2,

        // Instructions flottantes - 8-12 cycles
        Instruction::FloatAdd { .. } | Instruction::FloatSub { .. } => 8,
        Instruction::FloatMul { .. } => 10,
        Instruction::FloatDiv { .. } => 15,
        Instruction::FloatCompare { .. } => 6,

        // Instructions de manipulation de bits - 2-4 cycles
        Instruction::BitTest { .. } | Instruction::BitSet { .. } | Instruction::BitClear { .. } => {
            2
        }
        ...
        Instruction::LoadControlRegister { .. } | Instruction::StoreControlRegister { .. } => 15,
        ...
        Instruction::EnableInterrupts | Instruction::DisableInterrupts => 3,
        ...
        Instruction::BcdAdd { .. } | Instruction::BcdSub { .. } => 6,
