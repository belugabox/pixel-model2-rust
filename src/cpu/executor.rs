...
use super::{
    arithmetic::ArithmeticUnit, bcd::BcdUnit, bit_manipulation::BitManipulationUnit,
    floating_point::FloatingPointUnit, instructions::*, logical::LogicalUnit,
    registers::ProcessorStatusWord, NecV60,
};
        ...
        M: MemoryInterface,
    {
        ...
        match &instruction.instruction {
            ...
            Instruction::RotateLeft { dest, src, count } => {
                ...
                self.registers
                    .psw
                    .set(ProcessorStatusWord::ZERO, result == 0);
                self.registers.pc += instruction.size;
            }
            ...
            Instruction::Unknown { opcode } => {
                return Err(anyhow!(
                    "Instruction inconnue: {:#08x} à l'adresse {:#08x}",
                    opcode,
                    instruction.address
                ));
            }
